...
public class PaymentCategoryService {
    ...
    private final String path = "/api/staff/payment-categories";
    
    public List<PaymentCategoryResponse> get() throws IOException {
        ...
        try (Response response = client.newCall(httpRequest).execute()) {
            ...
            WebResponse<List<PaymentCategoryResponse>> webResponse = om.readValue(
                    jsonResponse, new TypeReference<WebResponse<List<PaymentCategoryResponse>>>(){}
            );
    ...
    public String add(PaymentCategoryRequest request) throws IOException{
        ...
        try (Response response = client.newCall(httpRequest).execute()) {
            ...
            String jsonResponse = response.body().string();
            WebResponse<PaymentCategoryResponse> webResponse;
            webResponse = om.readValue(
                    jsonResponse, new TypeReference<WebResponse<PaymentCategoryResponse>>() {}
            );
    ...
    public String update(String code, PaymentCategoryRequest request) throws IOException{
        String jsonRequest = om.writeValueAsString(request);
        ...
        try (Response response = client.newCall(httpRequest).execute()) {
            ...
            String jsonResponse = response.body().string();
            WebResponse<PaymentCategoryResponse> webResponse = om.readValue(
                    jsonResponse, new TypeReference<WebResponse<PaymentCategoryResponse>>(){}
            );
